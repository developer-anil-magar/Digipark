const Pricing = () => {
  return (
    <section className="mt-10 xl:mt-28">
      <div className="flex flex-col xl:flex-row gap-8 xl:gap-[120px] bg-gray-3 px-6 lg:px-24 py-12 rounded-40">
        ...
        <article className="flex gap-4 md:gap-12">
          ...
          <div className="border-l-2 border-gray-4 h-24 mt-6 xl:mt-28" />
          <div className="flex flex-col justify-center gap-3">
            <h1 className="text-white-1 semibold-86">
